	...
	<div class="container">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
				<li><a href="{{route('home')}}">বাড়ি</a></li>
...
<div class='col-md-9'>
            ...
            <div id="owl-single-product">
                ...
                @foreach ($multiImag as $image)
                    <div class="single-product-gallery-item" id="slide{{$image->id}}">
                        <a data-lightbox="image-1" data-title="Gallery" href="{{asset('storage/product/multiple_img/'.$image->photo_name)}}">
                            <img class="img-responsive" alt="slider" src="{{asset('storage/product/multiple_img/'.$image->photo_name)}}" data-echo="{{asset('storage/product/multiple_img/'.$image->photo_name)}}" />
                        </a>
            ...
            @foreach ($multiImag as $img)
                <div class="item">
                    <a class="horizontal-thumb active" data-target="#owl-single-product" data-slide="1" href="#slide{{$img->id}}">
                        <img class="img-responsive" width="85" alt="" src="{{asset('storage/product/multiple_img/'.$img->photo_name)}}" data-echo="{{asset('storage/product/multiple_img/'.$img->photo_name)}}" />
                    </a>
                </div>
                @endforeach
					...
					<div class='col-sm-6 col-md-7 product-info-block'>
						<div class="product-info">
							...
							<div class="description-container m-t-20">
                                @if(session()->get('language') == 'bangla') {{$products->short_desc_bn}} @else{{$products->short_desc_en}} @endif
					...
					<!-----------Color And Size --------->
					<div class="row">
						@if ($products->product_color_en == null)
									...
									<div class="col-sm-2">
										<div class="cart-quantity">
											<div class="quant-input">
												...
												<input type="text" id="qty"class="form-control" value="1" min="1">
							              </div>
							            </div>
									</div>
								...
								<div id="description" class="tab-pane in active">
									<div class="product-tab">
										<p class="text">
                                            ...
                                            @if(session()->get('language') == 'bangla') {!! $products->long_desc_bn !!} @else{!! $products->long_desc_en !!} @endif
                                        </p>
									</div>	
								</div><!-- /.tab-pane -->
	...
	<div class="owl-carousel home-owl-carousel upsell-product custom-carousel owl-theme outer-top-xs">
		...
		<div class="product-image">
			<div class="image">
				<a href="{{url('product/details/'.$related->id.'/'.$related->product_slug_en)}}"><img  src="{{asset('storage/product/'.$related->product_thumbnail)}}" alt=""></a>
			</div><!-- /.image -->			

			@php
			$amount=$related->selling_price - $related->discount_price;
			$discounts=($amount/$related->selling_price) * 100;
			@endphp
		...
		<div class="product-info text-left">
			<h3 class="name"> <a href="{{url('product/details/'.$related->id.'/'.$related->product_slug_en)}}">
				@if(session()->get('language') == 'bangla') {{ Str::limit($related->product_name_bn,25)}} @else {{ Str::limit($related->product_name_en,25)}} @endif
			  </a></h3>
			<div class="rating rateit-small"></div>
